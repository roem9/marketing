                    ...
                    <div class="card-body fo-14">
                        ...
                        <div class="form-detail" id="form-2">
                            ...
                            <div class="form-group">
                                ...
                                <input class='form-control form-control-sm' type="text" name="nama_agency" id="nama_agency" autocomplete="off" autocorrect="off" autocapitalize="off" readonly>
                            </div>
                            <div class="form-group">
                                <label for="nama_pemilik">Nama Pemilik</label>
                                <input class='form-control form-control-sm' type="text" name="nama_pemilik" id="nama_pemilik" autocomplete="off" autocorrect="off" autocapitalize="off" readonly>
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input class='form-control form-control-sm' type="email" name="email" id="email" autocomplete="off" autocorrect="off" autocapitalize="off" readonly>
                            </div>
                            <div class="form-group">
