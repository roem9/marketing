            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="row">
                            <div class="col">
                                <h6 class="m-0 font-weight-bold text-primary">Input Marketing Sharia Institute <?php if($lac)echo '"' . $lac['nama_lac'] .'"'?></h6>
                            </div>
                        </div>
                        </div>
                        <div class="card-body">
                            <?php if($lac) :?>
                                ...
                                <form action="<?= base_url()?>marketing/insertmarketingsi" method="POST" enctype="multipart/form-data" id="formInputMarketing">
                                    <input type="hidden" name="id_lac" value="<?= $lac['id_lac']?>">
                                    <div class="form-detail" id="form-1">
                                        <div class="form-group">
                                            <label for="nama">Nama Lengkap <span class="text-danger">*</span></label>
                                            <input data-form="Nama Lengkap" type="text" maxlength=100 name="nama" id="nama" class="form-control form-control-sm form-1" autocomplete="off" autocorrect="off" autocapitalize="off">
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email <span class="text-danger">*</span></label>
                                            <input data-form="Email" type="text" maxlength=100 name="email" id="email" class="form-control form-control-sm form-1" autocomplete="off" autocorrect="off" autocapitalize="off">
                                        </div>
                                        <div class="form-group">
                                            <label for="no_wa">No Whatsapp <span class="text-danger">*</span></label>
                                            <input data-form="No Whatsapp" type="text" maxlength=13 name="no_wa" id="no_wa" class="form-control form-control-sm form-1" autocomplete="off" autocorrect="off" autocapitalize="off">
                                        </div>
                                        <div class="form-group">
                                            <label for="no_hp">No Handphone <span class="text-danger">*</span></label>
                                            <input data-form="No HP" type="text" maxlength=13 name="no_hp" id="no_hp" class="form-control form-control-sm form-1" autocomplete="off" autocorrect="off" autocapitalize="off">
                                        </div>
                                        <div class="form-group">
                                            <label for="t4_lahir">Tempat Lahir <span class="text-danger">*</span></label>
                                            <input data-form="Tempat Lahir" type="text" maxlength=100 name="t4_lahir" id="t4_lahir" class="form-control form-control-sm form-1" autocomplete="off" autocorrect="off" autocapitalize="off">
                                        </div>
                                        <div class="form-group">
                                            <label for="tgl_lahir">Tgl Lahir <span class="text-danger">*</span></label>
                                            <input data-form="Tgl Lahir" type="date" name="tgl_lahir" id="tgl_lahir" class="form-control form-control-sm form-1">
                                        </div>
                                        <div class="form-group">
                                            <label for="tgl_masuk">Tgl Masuk <span class="text-danger">*</span></label>
                                            <input data-form="Tgl Masuk" type="date" name="tgl_masuk" id="tgl_masuk" class="form-control form-control-sm form-1">
                                        </div>
...
<script>
    ...
    $("#next-form-1").click(function(){
        ...
        if(empty == true){
            Swal.fire({
                icon: 'error',
                html: 'Harap mengisi data berikut ini : ' + html
            })
            return false;
        } else {
