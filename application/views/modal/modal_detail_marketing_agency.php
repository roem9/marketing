<form action="" method="post" id="formDetailMarketing">
                        ...
                        <div class="card-body fo-14">
                            ...
                            <div class="form-detail" id="form-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class='form-control form-control-sm' type="text" name="cabang_bank" id="cabang_bank" autocomplete="off" autocorrect="off" autocapitalize="off">
                                </div>
                                <div class="form-group">
