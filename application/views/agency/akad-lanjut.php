...
<html lang="en"><head>
    ...
    <p class="center bold">Pasal 1<br>Mukadimah Akad Syirkah Abdan<br>(KETENTUAN POKOK HUKUM SYARA' TENTANG SYIRKAH ABDAN)</p>
    ...
    <p class="center bold">Pasal 2<br>RUANG LINGKUP USAHA</p>
    <ol type="1" style="padding-left: 15px">
        <li>Usaha Syirkah Abdan ini adalah usaha Agency Pemasaran Properti Syariah pada badan usaha <b><?=$akad['nama_agency']?></b>.</li><br>
    ...
    <p class="center bold">Pasal 5<br>HAK</p>
    <p>Para Pihak menyepakati pembagian tanggung jawab sebagai berikut :</p>
    <ul style="padding-left: 15px">
    ...
    <p class="center bold">Pasal 6<br>PENGAMBILAN KEPUTUSAN</p>
    <ol type="1" style="padding-left: 15px">
    ...
    <p class="center bold">Pasal 7<br>PENYERTAAN MODAL</p>
    <p>Tidak ada penyertaan modal dalam syirkah ini karena bentuk syirkahnya adalah Syirkah Abdan.</p>

    <p class="center bold">Pasal 8<br>PEMBAGIAN KEUNTUNGAN</p>
    <ol type="1" style="padding-left: 15px">
    ...
    <p class="center bold">Pasal 9<br>PEMBAGIAN KERUGIAN</p>
    ...
    <p class="center bold">Pasal 10<br>REKENING PEMBAYARAN</p>
    <ol type="1" style="padding-left: 15px">
        <li>Rekening Pihak Kedua untuk kebutuhan pembayaran pembagian keuntungan dari Pihak Pertama adalah sebagai berikut :<br><br>
            <table style="margin-left: 50px" width=100%>
                <tr>
                    ...
                    <td>: <?=$akad['nama_bank']?></td>
                </tr>
                <tr>
                    <td>Cabang Bank</td>
                    <td>: <?=$akad['cabang_bank']?></td>
                </tr>
                <tr>
    ...
    <p class="center bold">Pasal 11<br>JANGKA WAKTU DAN PERIODE SYIRKAH</p>
    <ol type="1" style="padding-left: 15px">
    ...
    <p class="center bold">Pasal 12<br>KERAHASIAN DAN PENCEMARAN NAMA BAIK</p>
    <ol type="1" style="padding-left: 15px">
    ...
    <p class="center bold">Pasal 13<br>PERSELISIHAN</p>
    <ol type="1" style="padding-left: 15px">
    ...
    <p class="center bold">Pasal 14<br>PENUTUP</p>
    <ol type="1" style="padding-left: 15px">
    ...
    <p>Ditetapkan tanggal : <?= tgl_indo($akad['tgl_akad'])?></p><br><br>
    ...
    <table style="margin-left: 300px" width=100%>
        ...
        <tr>
            <td class="center"><u><b>NASUHA ALHUDA SYAHPUTRA, SE</b></u></td>
        </tr>
    </table><br>
